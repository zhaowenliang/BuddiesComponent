...
public class MediaStoreAddition {
    ...
    public static ContentValues getImageContentValues(String path, String displayName, String mime) {
        ...
        try {
            ...
            return getImageContentValues(path, displayName, null, mime, width, height, degree, size, datetime, location);
        } catch (IOException e) {
            e.printStackTrace();
        }
     ...
     */
    public static ContentValues getImageContentValues(String path, String displayName, String title, String mime,
    ...
    public static ContentValues getVideoContentValues(String path, String displayName) {
        ...
        return getVideoContentValues(path, displayName, null, strMimeType, width, height, size, duration, datetime, location);
    }
     ...
     * @return ContentValues
     */
    public static ContentValues getVideoContentValues(String path, String displayName, String title, String mime,
